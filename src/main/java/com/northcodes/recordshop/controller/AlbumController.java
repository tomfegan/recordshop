...
public class AlbumController {
    ...
    @DeleteMapping("/albumsByName/{albumName}")
    ...
    public ResponseEntity<Album> updateAlbumDetails(@PathVariable("id") Long id, @RequestBody Album albumToUpdate) {
